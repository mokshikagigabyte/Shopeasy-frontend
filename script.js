...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const protectedPages = ['index.html', 'men.html', 'category.html', 'yourcart.html', 'wishlist.html', 'qr.html', 'cod.html', 'help.html'];
  ...
  function loadProducts(query = '') {
    const productPages = ['index.html', 'men.html', 'category.html'];
